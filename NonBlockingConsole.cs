...
{
    /// <summary>
    /// Class <c>NonBlockingConsole</c> creates a queue for asynchronous writing to console
    ...
    static class NonBlockingConsole
    {
        ...
        /// <summary>
        /// Method <c>NonBlockingConsole</c> The constructor creates a separate thread, where strings are written to the console asynchronously
        /// </summary>
